...
- Frontend/dashboard document listing should no longer throw `relation "public.documents" does not exist`; run a quick smoke test after logging in as `admin@fetchtext.local / ***REMOVED-TEST-PASSWORD***`.
