...
**Files:**
- Modify: `/localai-admin-dashboard/.env.local`
...
Run: `grep VITE_SENDGRID localai-admin-dashboard/.env.local`
...
**Files:**
- Modify: `/localai-admin-dashboard/src/config/email.ts`
...
Run: `cd localai-admin-dashboard && node scripts/test-invitation-email.mjs`
...
| `/localai-admin-dashboard/.env.local` | `VITE_SENDGRID_FROM_EMAIL=nick@fetchtext.io` |
| `/localai-admin-dashboard/src/config/email.ts` | Update fallback defaults |
