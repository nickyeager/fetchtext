...
class LocalAIMonitor:
    ...
    def _load_service_configs(self) -> List[ServiceConfig]:
        ...
        return [
            ...
            ServiceConfig("Qdrant", "qdrant", 6333, 6333, "/", "text/html"),
            ...
            ServiceConfig("Neo4j", "localai-neo4j-1", 7474, 7474, "/", "text/html"),
            ...
            ServiceConfig("Supabase Kong", "supabase-kong", 8000, 8000, "/", None),
